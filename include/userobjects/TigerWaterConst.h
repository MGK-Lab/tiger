...
#ifndef TIGERWATERCONST_H
#define TIGERWATERCONST_H

#include "SinglePhaseFluidPropertiesPT.h"

class TigerWaterConst;

template <>
InputParameters validParams<TigerWaterConst>();

class TigerWaterConst : public SinglePhaseFluidPropertiesPT
{
public:
  TigerWaterConst(const InputParameters & parameters);
  virtual ~TigerWaterConst();
